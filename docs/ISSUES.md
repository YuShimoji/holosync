...
- [ ] UI modernization / icon consistency.
  ...
  - Current state: needs design audit before broad redesign.
  ...
  - Next candidates: design tokens, inline SVG unification, focus-visible/hover/disabled states, and WCAG AA contrast checks.
...
- [ ] SP-021/F-04: Main-area search UI.
  ...
  - Current state: all other SP-021 items are implemented.
- [ ] Format debt cleanup.
