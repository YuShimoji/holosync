...
| # | 機能 | 仕様 | Phase | 優先度 | 備考 |
|---|------|------|-------|--------|------|
| 1 | F-02 最大化モード再分類 | SP-021 | B | 中 | シアター/フォーカス/ポップアウト |
| 2 | F-10 双方向フィット | SP-021 | B | 中 | Electron専用のウィンドウサイズ調整 |
| 3 | F-07 YouTube風コントロール | SP-021 | C | 中 | iframe制約内で実装 |
| 4 | F-04 メインエリア検索 | SP-021 | D | 低 | ウェルカム画面+大画面検索 |
| 5 | F-09 ルーペ拡張 | SP-021 | D | 低 | サイズ拡大+角丸調整 |
