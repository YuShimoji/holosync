...
| 23 | F-01 クイックフィット | SP-021 partial | 手動 | 2026-04-14 要確認 | Fキー+ボタン+自動アスペクトオプション |
| 24 | F-05 スクロール/ドラッグ衝突解消 | SP-021 partial | 手動 | 2026-04-14 要確認 | CSS scrollbar no-drag |
| 25 | F-08 ブラウザ遷移防止 (最小版) | SP-021 partial | 手動 | 2026-04-14 要確認 | setWindowOpenHandler 全deny + 明示外部起動API |
| 26 | F-09 ルーペ拡張 | SP-021 partial | 手動 | 2026-04-15 要確認 | 直径1.5倍 + radius slider |
| 27 | F-10 双方向フィット | SP-021 partial | 手動 | 2026-04-15 要確認 | #fitWindowBtn (Electron 専用) |

## 未実装機能 (SP-021 残り)

| # | 機能 | 仕様 | Phase | 優先度 | 備考 |
|---|------|------|-------|--------|------|
| 1 | F-02 最大化モード再分類 | SP-021 | B | done | モード体系再分類 + Full-Fit 廃止 (2026-04-15) |
| 2 | F-07 YouTube風コントロール | SP-021 | C | done | タイル下部にYouTube風コントロールバー (2026-04-15) |
| 3 | F-04 メインエリア検索 | SP-021 | D | 低 | 検索結果とグリッドの配置方針で user 判断要 |
